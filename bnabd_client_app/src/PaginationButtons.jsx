...
export class PaginationButtons extends Component {
    ...
    render() {
        ...
        return (
            <>
                <button className="btn btn-secondary mx-1" onClick={() => navigate(current - 1)} disabled={current == 1}>
                    Previous
                </button>
                {current > 4 && (
                    <>
                ...
                {current <= pageCount - 4 && (
                    <>
                        <span className="h4">...</span>
                        <button className="btn btn-secndary mx-1" onClick={() => navigate(pageCount)}>
                            {pageCount}
                        </button>
                    </>
                )}
